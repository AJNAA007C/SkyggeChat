...
import com.android.rfchat.service.ServiceUtils;
import com.android.rfchat.ui.FriendsFragment;
import com.android.rfchat.ui.GroupFragment;
import com.android.rfchat.ui.LoginActivity;
import com.android.rfchat.ui.UserProfileFragment;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity {
    private static String TAG = "MainStegnoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Skygge");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Skygge version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
