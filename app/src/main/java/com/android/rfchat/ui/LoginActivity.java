...
public class LoginActivity extends AppCompatActivity {
    ...
    public static boolean isforRegister=false;
        ...
        void saveUserInfo() {
            FirebaseDatabase.getInstance().getReference().child("user/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    userInfo.password = pword;
                    userInfo.email = (String) hashUser.get("email");
                    userInfo.avata = (String) hashUser.get("avata");
                    SharedPreferenceHelper.getInstance(LoginActivity.this).saveUserInfo(userInfo);
                    SharedPreferenceHelper.getInstance(LoginActivity.this).saveUserPwd(userInfo);
                }
    ...
    protected void onPostResume() {
        ...
        if ( isforRegister) {
            isforRegister=false;
            authUtils.createUser(StaticConfig.STR_EXTRA_USERNAME,StaticConfig.STR_EXTRA_PASSWORD);
        }
    }
}
